...
class PolarisConfig(BaseComputeConfig):
    ...
    num_nodes: int = 1
    """Number of nodes to request"""
    worker_init: str = 'module use /soft/modulefiles; module load conda; conda activate agents; cd /lus/eagle/projects/FoundEpidem/bhsu/2024_research/agents/agents/'
    """How to start a worker. Should load any modules and environments."""
