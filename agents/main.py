...
def construct_action_agent(agent_name: str,
    ...
    action_agent_cls, cls_container, cls_payload = action_agent_registry.get(agent_name).values()
    ...
    return action_agent_cls(**asdict(cls_payload))

def parse_args() -> Any: 
    parser = ArgumentParser()
    parser.add_argument('--agent_name', type=str, default='Python', help='What kind of agent to use')
    parser.add_argument('--generator', type=str, default='Argo', help='What kind of generator to use')
    parser.add_argument('--parse_type', type=str, default='dict', help='What kind of parsing strategy to use for parser')
    parser.add_argument('--use_solver', action='store_true', help='Whether to use parser or not')
...
def main():
    ...
    agent = construct_action_agent('Python', 
