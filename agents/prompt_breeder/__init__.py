...
def init_run(population: Population, model: BaseLLMGenerator, num_evals: int):
...
def run_for_n(n: int, population: Population, model: BaseLLMGenerator, num_evals: int):
...
def _evaluate_fitness(population: Population, model: BaseLLMGenerator, num_evals: int) -> Population:
