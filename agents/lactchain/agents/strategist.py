...
from agents.lactchain.prompts.strategy_prompt import (StrategyInputPayload,
                                                      StrategyOutputPayload,
                                                      StrategyPromptTemplate)
from agents.lactchain import lactchain_agent_registry

T = TypeVar('T')

AGENT_NAME = 'lactchain_strategist'
...
@lactchain_agent_registry.register(AGENT_NAME,
